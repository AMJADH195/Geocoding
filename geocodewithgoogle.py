...
API_KEY = 'AIzaSyCNk8Wokbl6euOlNTxWLb1Usn-XB6zd5EM'
# Backoff time sets how many minutes to wait between google pings when your API limit is hit
BACKOFF_TIME = 30
# Set your output file name here.
output_filename = 'data/output.csv'
# Set your input file here
input_filename = "data/shared_IIITMK.csv"
# Specify the column name in your input data that contains addresses here
address_column_name = "add1"
...
def get_google_results(address, api_key='AIzaSyCNk8Wokbl6euOlNTxWLb1Usn-XB6zd5EM', return_full_response=False):
    """
